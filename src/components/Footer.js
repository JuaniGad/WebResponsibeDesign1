    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        <div className={`${styles.flexStart} md:flew-row flex-col mb-8 w-full`}>
            <div className="flex-1 flex- flex-col justify-start mr-10 ">
                <img src={logo} alt="hoobanck" className="w-[260px] h-[72px] object-contain"/>
                    ...
                    <div key={footerLink.key} className="flex       flex-cl ss:my-0 my-4 min-w-[150px]">
                        ...
                        <h4 className="mt-10 font-poppins font-medium text-[18px] leading-[27px] text-white">
                            ...
                            {footerLink.links.map((link,index)=>
                               ( <li key={link.name} className={`list-none mt-4 font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer ${index !== footerLink.links.length -1 ? 'mb-4': 'mb-0'}`}>
        ...
        <p className="font-poppins font-normal text-center  tex-[18px] leading-[27px] text-white"> 2022 HooBank, All Rights Reserved. </p>
        </div>
